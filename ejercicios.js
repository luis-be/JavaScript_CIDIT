...
function logMessage() {
    console.log('Hola! Estoy imprimiendo un mensaje');
}

// 13. Utiliza `console.log()` para imprimir el valor de la variable `edad` que tiene el valor 30.
function logAge() {
    let edad = 30
    console.log('La edad de esta persona es de: ' + edad + ' años');
}
